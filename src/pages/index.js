...
export default function Home() {
  ...
  const fetchWeatherData = async (lat, lon, city = null) => {
    try {
      ...
      const isRaining = weatherResponse.data.weather[0].main
        .toLowerCase()
        .includes("rain");
      if (isRaining) {
  ...
  if (!weatherData) {
    return (
      <div
        ...
        style={{ background: BACKGROUND_COLORS[backgroundTheme] }}>
  ...
  const formatTime = `${currentTime.getHours() % 12 || 12}:${currentTime
    .getMinutes()
    .toString()
    .padStart(2, "0")}`;
  ...
  return (
    <>
      ...
      <main
        ...
        <div
          className="transition-all duration-1000 ease-linear relative isolate text-white py-4 min-h-screen"
          style={{ background: BACKGROUND_COLORS[backgroundTheme] }}>
                  ...
                  <div className="flex items-center space-x-6 mt-4">
                    ...
                    <div>
                      <p className="text-6xl font-bold">
                        ...
                        <span className="text-2xl font-medium align-top">
                          °C
                        </span>
                      </p>
              ...
              <div className="grid grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-6 bg-white/5 ring-1 ring-white/10 shadow-sm rounded-lg p-8 backdrop-blur-sm">
                ...
                <Card title="Feels Like">
                  ...
                  <p>
                    ...
                    <span className="text-[9px] font-medium align-top ml-0.5">
                      °C
                    </span>
                  </p>
                </Card>
